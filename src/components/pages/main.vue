...
export default {
  ...
  methods: {
    ...
    async fetchTotalMembers() {
      try {
        const response = await axios.get('https://work-8enqno6vr-danyas-projects-f55a11c7.vercel.app/');
        const totalMembers = response.data.totalMembers || '0'; // Данные с сервера
